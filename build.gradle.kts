...
group = "io.k-libs"
version = "1.0.0"
description = "Closable resource definition."
  ...
  publications {
    withType<MavenPublication> {
      ...
      pom {
        ...
        scm {
          connection.set("scm:git:git://github.com/k-libs/k-closeable.git")
          developerConnection.set("scm:git:ssh://github.com/k-libs/k-closeable.git")
          url.set("https://github.com/k-libs/k-closeable")
        }
      }
    }
